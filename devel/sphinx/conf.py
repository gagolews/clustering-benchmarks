...
project = 'clustering-benchmarks'
copyright = '2020–2022, Marek Gagolewski'
author = 'Marek Gagolewski'
html_title = project
html_short_title = project

version = clustbench.__version__
release = version

print("This is %s %s by %s.\n" % (project, version, author))


github_project_url = "https://github.com/gagolews/clustering-benchmarks/"
