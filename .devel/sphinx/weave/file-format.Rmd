...
<!--
It is assumed the algorithms do not mark any points as noise
(if they do, some postprocessing might be required, e.g.,
the merging of noise points with the nearest clusters thereto).
-->
