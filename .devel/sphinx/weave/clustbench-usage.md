...
The datasets from the {ref}`sec:suite-v1` can be queried easily.
...
Say we would like to study
one of the sets of [precomputed clustering results](https://github.com/gagolews/clustering-results-v1)
...
The results can be fetched by calling:
...
We thus have got access to data generated by the [*Genie*](https://genieclust.gagolewski.com)
